...
# ggsave(filename = "../figs/Fig3u.svg", plot = f2u, device = 'svg', units = 'in', width = fig_width, height = fig_height)
ggsave(filename = "../figs/Fig3u.png", plot = f2u, device = 'png', units = 'in', width = fig_width, height = fig_height)
```

...then Fig 3b.

```{r}
# ggsave(filename = "../figs/Fig3l.svg", plot = f2l, device = 'svg', units = 'in', width = fig_width, height = fig_height)
ggsave(filename = "../figs/Fig3l.png", plot = f2l, device = 'png', units = 'in', width = fig_width, height = fig_height)
```
