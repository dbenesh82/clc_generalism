...
sx1
ggsave(sx1, filename = "../../figs/FigSXa.svg", device = 'svg', width = 4.5, height = 4.5)
ggsave(sx1, filename = "../../figs/FigSXa.png", device = 'png', width = 4.5, height = 4.5)
```
...
sx2 <- ggplot(df_comp, aes(x = tax_post.mean, y = phy_post.mean)) +
  ...
  theme(panel.grid.minor = element_blank())
sx2
ggsave(sx2, filename = "../../figs/FigSXb.svg", device = 'svg', width = 4.5, height = 4.5)
ggsave(sx2, filename = "../../figs/FigSXb.png", device = 'png', width = 4.5, height = 4.5)
```
