...
Export as SVG and PNG, first Fig 2a...

```{r}
fig_width <- 4.5
fig_height <- 4.5

ggsave(filename = "../figs/Fig2a.svg", plot = f1a, device = 'svg', units = 'in', width = fig_width, height = fig_height)
ggsave(filename = "../figs/Fig2a.png", plot = f1a, device = 'png', units = 'in', width = fig_width, height = fig_height)
```

...then Fig 2b.

```{r}
ggsave(filename = "../figs/Fig2b.svg", plot = f1b, device = 'svg', units = 'in', width = fig_width, height = fig_height)
ggsave(filename = "../figs/Fig2b.png", plot = f1b, device = 'png', units = 'in', width = fig_width, height = fig_height)
```
