...
```{r}
dat_host <- read.csv(file="../../data/host_names_corrected_valid.csv", header = TRUE, sep=",") # corrected host names
...
h.sp.vec <- unique(dat_host$best_host_name)
h.sp.vec <- sort(na.omit(h.sp.vec))

g.sp.vec <- unique(dat_host$best_host_name_genus)
