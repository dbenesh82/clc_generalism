...
s7a
ggsave(s7a, filename = "../../figs/FigS8a.svg", device = 'svg', height = 4, width = 4)
```
...
s7b <- ggplot(filter(chains3, web_study == "Lafferty et al. (2006)", third_hosts != 0),
  ...
  guides(color = F)
s7b
ggsave(s7b, filename = "../../figs/FigS8b.svg", device = 'svg', height = 4, width = 4)
```
...
s7c <- ggplot(filter(chains3, web_study == "Lafferty et al. (2006)", second_hosts != 0),
  ...
  guides(color = F)
s7c
ggsave(s7c, filename = "../../figs/FigS8c.svg", device = 'svg', height = 4, width = 4)
```
```{r}
s7d <- ggplot(filter(chains3, web_study == "Lafferty et al. (2006)", second_hosts != 0),
  ...
  guides(color = F)
s7d
ggsave(s7d, filename = "../../figs/FigS8d.svg", device = 'svg', height = 4, width = 4) # combine S7 a to d into one plot
```
