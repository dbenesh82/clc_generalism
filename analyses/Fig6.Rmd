...
ggsave(filename = "../figs/Fig6a.svg", plot = f1a2, device = 'svg', units = 'in', width = fig_width, height = fig_height)
ggsave(filename = "../figs/Fig6a.png", plot = f1a2, device = 'png', units = 'in', width = fig_width, height = fig_height)
ggsave(filename = "../figs/Fig6b.svg", plot = f1b2, device = 'svg', units = 'in', width = fig_width, height = fig_height)
ggsave(filename = "../figs/Fig6b.png", plot = f1b2, device = 'png', units = 'in', width = fig_width, height = fig_height)
```
