...
stage_avg <- mutate(stage_avg, facultative_lc = if_else(lcl_max != lcl_min, "facultative", "not facultative"))
```
...
reg4f <- update(reg3.1f, . ~ . + facultative_lc) # distinguish fac life cycles
...
reg4p <- update(reg3.1p, . ~ . + facultative_lc) # distinguish fac life cycles
